  ...
  return (
    <nav
      ...
      style={{
        ...
        background: palette.isDark ? "rgba(9,17,28,0.90)" : "rgba(255,255,255,0.62)",
        ...
        return (
          <button
            ...
            style={{
              ...
              background: active ? (palette.isDark ? "rgba(24,167,225,0.12)" : "rgba(24,167,225,0.08)") : "transparent",

...
export default function AppChrome(props) {
  ...
  return (
    <>
      ...
      <div
        ref={isMobile ? mobileChromeRef : null}
        style={
          isMobile
            ? {
                position: "relative",
                background: `linear-gradient(180deg, ${c.bg}F2 0%, ${c.bg}E8 72%, ${c.bg}00 100%)`,
                backdropFilter: "blur(10px)",
                padding: `calc(${safeTop} + 4px) 10px 6px`,
      ...
      >
        <div
          style={{
            ...
            padding: isMobile ? "10px 0 9px" : "18px 0 14px",
            borderBottom: `1px solid ${c.border}`,
            ...
            {hasAuthenticatedUser && (
              <div
                ...
                style={{
                  ...
                  alignItems: "center",
                  gap: 8,
                  padding: isMobile ? "8px 11px" : "7px 11px",
                  borderRadius: 12,
              ...
              >
                ...
                <div style={{ display: "grid", minWidth: 0, lineHeight: 1.1 }}>
                  ...
                  <span style={{ fontSize: 12, color: c.tx, fontWeight: 800, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                    {signedInLabel}
                  </span>
                </div>
              </div>

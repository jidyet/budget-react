      ...
      <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.15fr .85fr", gap: 16 }}>
        <div>
          ...
          <div style={{ display: "grid", gap: 8 }}>
            {[[boaLabel, boaPayPeriods], [eagleviewLabel, eagleviewPayPeriods]].map(([label, periods]) => (
        ...
        <div>
          ...
          <div style={{ fontSize: 11, color: c.muted, marginTop: 8 }}>
            {boaLabel}: {boaPayPeriods.length} periods - {eagleviewLabel}: {eagleviewPayPeriods.length} periods - Custom recurring: {incomeTemplates.length}
          </div>
        </div>
      </div>
    </div>
